                                        ...
                                        inputs: [
                                            {
                                                ...
                                                options: {
                                                    ...
                                                    url: 'http://172.17.41.27/api/documents/sync/settlements/fromFile',
                                                    paramName: 'file',
                                                    method: 'POST',
                                                    acceptedFiles: '.csv',
                                                    addRemoveLinks: true,
                                        ...
                                        inputs: [
                                            {
                                                ...
                                                options: {
                                                    url: 'http://172.17.41.27/api/documents/sync/settlements/fromJson'
                                                }
                                            }
                                        ]
                                    }
                        ...
                        inputs: [
                            {
                                instance: datePicker,
                                options:{
                                    url: 'http://172.17.41.27/api/documents/settlements/sync/dateRange'
                                }
                            }
                        ]
                    }
